export function setupFilter() {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Главная: id="product-list"; Каталог: только класс goods__list
    const isMain = productContainer && productContainer.id === 'product-list';
    ...
    function getFilters() {
      ...
      // Собираем только реально выбранные фильтры
      const filters = {};
      ...
      // Пример: если есть фильтры по цене
